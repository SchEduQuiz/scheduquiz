const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/browser-C5E9L-9o.js","assets/vendor-B1QZAsoL.js"])))=>i.map(i=>d[i]);
import { b as getAugmentedNamespace, g as getDefaultExportFromCjs } from "./vendor-B1QZAsoL.js";
...
class RealtimeClient {
  ...
  connect() {
    ...
    __vitePreload(async () => {
      const { default: WS } = await import("./browser-C5E9L-9o.js").then((n) => n.b);
      return { default: WS };
    }, true ? __vite__mapDeps([0,1]) : void 0).then(({ default: WS }) => {
...
//# sourceMappingURL=supabase-C1mDbcUM.js.map
